...
describe("Marketplace", function () {
  ...
  //   // Add a new isting
  //   await nft.connect(player1).approve(market.address, 0);
  //   await market.connect(admin).setWhitelistTokens(["0x81f91E226c663574b4619926Bea0DDe889d0fe08"]);
  //   await market
  //     .connect(player1)
  //     .addListing(0, ethers.utils.parseUnits("5"), "0x81f91E226c663574b4619926Bea0DDe889d0fe08");
  //   await nft.connect(player1).approve(market.address, 1);
  //   await market
  //     .connect(player1)
  //     .addListing(1, ethers.utils.parseUnits("10"), "0x81f91E226c663574b4619926Bea0DDe889d0fe08");
